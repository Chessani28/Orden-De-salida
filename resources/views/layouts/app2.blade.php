...
<head>
    <script src="https://kit.fontawesome.com/1bd49bb9e1.js" crossorigin="anonymous"></script>
    <meta charset="utf-8">
    ...
    <link href="{{ asset('css/detalleInstalacion.css') }}" rel="stylesheet" />
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="./datosvendedor">
                                <i class="ni ni-circle-08 text-primary"></i> Clientes
                            </a>
                        </li>
                    </ul>
                    <!-- Divider -->
